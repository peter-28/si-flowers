...
function displayData(id = null, type = null) {
    $.ajax({
        url: `/admin/analisis-harga-satuan/ahs-master/create`,
        method: "get",
...
function getFilterMaterials() {
    ...
    $.ajax({
        url: '/admin/analisis-harga-satuan/ahs-master/filter/material',
        data: dataFilter,
...
function openModal(data, type, id) {
    if (type == 'add') {
        ...
        $.ajax({
            url: `/admin/analisis-harga-satuan/ahs-master/generate/code`,
            type: "get",
            success: async function (response) {
                console.log(response)
                $("#kode").val(response);
        ...
        $.ajax({
            ...
            success: async function (response) {
                ...
                $.ajax({
                    url: `/admin/analisis-harga-satuan/ahs-master/${id}`,
                    method: "get",
                    success: function (response) {
        ...
        case "save":
            if ($(`#form-data-ahs-master`).valid()) {
                $(`#form-data-ahs-master`).submit(function (e) {
                    ...
                    $.ajax({
                        url: `/admin/analisis-harga-satuan/ahs-master`,
                        type: "post",
                        data: formData,
                        dataType: "json",
                        cache: false,
...
function expandRow(id_ahs) {
    ...
    $.ajax({
        url: `/admin/analisis-harga-satuan/ahs-master/${id_ahs}`,
        method: "get",
        success: function (response) {
            console.log(response)
